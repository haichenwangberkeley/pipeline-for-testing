---
skill_id: SKILL_13TEV25_DETAILS
display_name: "13 TeV 2025 Data — Beta"
version: 1.0
category: other

summary: "13 TeV 2025 Data — Beta"
...
when_to_use:
  - "Use when executing or validating the dataset_specific stage of the analysis workflow."
...
postconditions:
  - "All declared outputs for SKILL_13TEV25_DETAILS are written with provenance."
...
This skill defines a structured execution contract for `open_data_specific/13tev25_details.md`.
...
- Source file: `open_data_specific/13tev25_details.md`
- Original stage: `dataset_specific`
